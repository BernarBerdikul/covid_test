...
PASSWORD_INVALID = _(
    f"Пароль должен быть не менее {constants.PASSWORD_MIN_LENGTH} символов"
)
LOGIN_FIRST_SYMBOL_VALIDATION = _(
    "Первый символ должен быть маленькой буквой английского алфавита, "
    "а логин состоять из английского алфавита, чисел и нижнего прочерка '_'"
)
VALUE_CONTAIN_RULE = _(
    "Строка должна содержать только числа и буквы английского алфавита"
)
